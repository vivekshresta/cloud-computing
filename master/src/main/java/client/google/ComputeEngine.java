...
public class ComputeEngine {
    ...
    public static Compute getComputeEngine() {
        ...
        try {
            ...
            String credentialPath = usingSystemProperty + "/src/main/resources/credentials/vivekshresta-bandaru-dbe8cfe0f754.json";
...
//
//      Operation op = startInstance(compute, SAMPLE_INSTANCE_NAME);
//      if (foundOurInstance) {
